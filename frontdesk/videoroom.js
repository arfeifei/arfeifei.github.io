...
var roomdesc = "VIP ROOM " + (Math.floor(1000 + Math.random() * 9000));
var roomsecret = "adminpwd" //admin password
var roompin = '1010'; //password
var roompublishers = 3;
var myroom = 0; // My room
var myusername = null;
var myid = null;
var mystream = null;
                        ...
                        janus.attach({
                            ...
                            success: function(pluginHandle) {
                                ...
                                sfutest.send({
                                    ...
                                    error: function(error) {
                                        bootbox.alert("Creating room failed " + error);
                                    }
                                });
                            },
                            error: function(error) {
